...
INSERT INTO `config` (`id`, `owner_phone`, `site_name`, `site_logo`, `meta_title`, `meta_description`, `meta_keywords`, `meta_author`, `discord_link`, `discord_webhook`, `banner_link`, `banner2_link`, `banner3_link`, `created_at`, `updated_at`) VALUES
(1, '0812345678', 'XXX', 'https://www.getampx.com/images/logo/amparexlogowithname.png', 'XXX - Template', 'ร้านขายโค้ด เกม และสินค้า Digital แท้ ปลอดภัย 100%', 'เกม, โค้ดแท้, steam, ps5, xbox, digital store', 'XXX - ประกาศ', 'https://discord.gg/abcd1234', 'https://discord.gg/abcd1234', 'https://img2.pic.in.th/pic/2000x5009e8abd4c1b6fc6df.jpg', 'https://img2.pic.in.th/pic/2000x5009e8abd4c1b6fc6df.jpg', 'https://img2.pic.in.th/pic/2000x5009e8abd4c1b6fc6df.jpg', '2025-09-29 13:28:13', '2025-09-29 18:25:56');
...
(1, 1, 'สินค้าตัวอย่าง', 'ทดสอบ', '150.00', '75.00', 168, 'ถาวร', 'https://img2.pic.in.th/pic/1500x1500.jpg', '', 1, 0, 1, 1, 'มีประกันถาวร', '#11ff00', '', '2025-09-11 14:07:32', 0, 0);

INSERT INTO `theme_settings` (`id`, `primary_color`, `secondary_color`, `background_color`, `text_color`, `updated_at`) VALUES
(1, '#00fc43', '#9333ea', '#f9fafb', '#111827', '2025-09-29 14:24:45');
...
(1, NULL, 'teerachot nuengsonri', 'Teerachat20005@gmail.com', '$2b$10$aILjX3WITHyrXcRTb.IrLe4F/sOteD79ILWspdcWe8KPYFCYEcofC', '0.00', 0, 'member', '2025-09-29 16:23:29');
